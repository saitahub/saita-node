...
The testing strategy for SaitaChain is 4-fold:
...
addition prometheus avoiding additional SaitaChain source changes.
...
For full examples on how to use [`grcov` /w SaitaChain specifics see the github
...
fn main() -> eyre::Result<()> {
 ...
 saitama_cli::run_node(cli, BehaveMaleficient)?;
 Ok(())
}
```
