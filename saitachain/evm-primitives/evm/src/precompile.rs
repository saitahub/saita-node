...
fn ensure_linear_cost(
	...
	log::info!("entered in the ensure_linear_cost of the primitives");
	let cost = base.checked_add(word.checked_mul(len.saturating_add(31) / 32).ok_or(	PrecompileFailure::Error {exit_status: ExitError::OutOfGas,},
		)?)
