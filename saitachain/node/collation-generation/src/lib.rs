...
//! The collation generation subsystem is the interface between saitachain and the collators.
//!
//! # Protocol
//!
...
fn erasure_root(
	...
	let chunks = saitama_erasure_coding::obtain_chunks_v1(n_validators, &available_data)?;
	Ok(saitama_erasure_coding::branches(&chunks).root())
}
