...
use saitama_node_subsystem_test_helpers as test_helpers;
use saitama_node_subsystem_util::TimeoutExt;
use saitama_overseer::HeadSupportsParachains;
...
where
	Compute: Fn() -> HashMap<saitama_primitives::CoreIndex, criteria::OurAssignment>,
...
impl<F>
	MockAssignmentCriteria<fn() -> HashMap<saitama_primitives::CoreIndex, criteria::OurAssignment>, F>
{
...
fn test_harness<T: Future<Output = VirtualOverseer>>(
	...
	let _ = keystore.sr25519_generate_new(
		saitama_primitives::PARACHAIN_KEY_TYPE_ID,
