		...
		let metrics = MetricsInner {
			validation_requests: prometheus::register(
				prometheus::CounterVec::new(
					prometheus::Opts::new(
						"saitachain_parachain_validation_requests_total",
			...
			validate_from_chain_state: prometheus::register(
				prometheus::Histogram::with_opts(prometheus::HistogramOpts::new(
					"saitachain_parachain_candidate_validation_validate_from_chain_state",
			...
			validate_from_exhaustive: prometheus::register(
				prometheus::Histogram::with_opts(prometheus::HistogramOpts::new(
					"saitachain_parachain_candidate_validation_validate_from_exhaustive",
			...
			validate_candidate_exhaustive: prometheus::register(
				prometheus::Histogram::with_opts(prometheus::HistogramOpts::new(
					"saitachain_parachain_candidate_validation_validate_candidate_exhaustive",
			...
			pov_size: prometheus::register(
				prometheus::HistogramVec::new(
					prometheus::HistogramOpts::new(
						"saitachain_parachain_candidate_validation_pov_size",
			...
			code_size: prometheus::register(
				prometheus::Histogram::with_opts(
					prometheus::HistogramOpts::new(
						"saitachain_parachain_candidate_validation_code_size",
