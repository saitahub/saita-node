		...
		let metrics = MetricsInner {
			open: prometheus::register(
				prometheus::Counter::with_opts(prometheus::Opts::new(
					"saitachain_parachain_candidate_disputes_total",
			...
			concluded: prometheus::register(
				prometheus::CounterVec::new(
					prometheus::Opts::new(
						"saitachain_parachain_candidate_dispute_concluded",
			...
			votes: prometheus::register(
				prometheus::CounterVec::new(
					prometheus::Opts::new(
						"saitachain_parachain_candidate_dispute_votes",
			...
			approval_votes: prometheus::register(
				prometheus::Counter::with_opts(prometheus::Opts::new(
					"saitachain_parachain_dispute_candidate_approval_votes_fetched_total",
			...
			queued_participations: prometheus::register(
				prometheus::CounterVec::new(
					prometheus::Opts::new(
						"saitachain_parachain_dispute_participations",
			...
			vote_cleanup_time: prometheus::register(
				prometheus::Histogram::with_opts(
					prometheus::HistogramOpts::new(
						"saitachain_parachain_dispute_coordinator_vote_cleanup",
			...
			prometheus::Counter::with_opts(
				prometheus::Opts::new(
					"saitachain_parachain_dispute_refrained_participations",
			...
			participation_durations: prometheus::register(
				prometheus::Histogram::with_opts(
					prometheus::HistogramOpts::new(
						"saitachain_parachain_dispute_participation_durations",
			...
			participation_pipeline_durations: prometheus::register(
				prometheus::Histogram::with_opts(
					prometheus::HistogramOpts::new(
						"saitachain_parachain_dispute_participation_pipeline_durations",
			...
			participation_priority_queue_size: prometheus::register(
				prometheus::Gauge::new("saitachain_parachain_dispute_participation_priority_queue_size", 
			...
			participation_best_effort_queue_size: prometheus::register(
				prometheus::Gauge::new("saitachain_parachain_dispute_participation_best_effort_queue_size", 
