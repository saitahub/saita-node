...
struct MetricsInner {
	...
	/// will count all recent statements meaning every dispute from last sessions: 4 hours on SaitaChain. The metrics are updated only when the
		...
		let metrics = MetricsInner {
			inherent_data_requests: prometheus::register(
				prometheus::CounterVec::new(
					prometheus::Opts::new(
						"saitachain_parachain_inherent_data_requests_total",
			...
			request_inherent_data_duration: prometheus::register(
				prometheus::Histogram::with_opts(prometheus::HistogramOpts::new(
					"saitachain_parachain_provisioner_request_inherent_data_time",
			...
			provisionable_data_duration: prometheus::register(
				prometheus::Histogram::with_opts(prometheus::HistogramOpts::new(
					"saitachain_parachain_provisioner_provisionable_data_time",
			...
			inherent_data_dispute_statements: prometheus::register(
				prometheus::CounterVec::new(
					prometheus::Opts::new(
						"saitachain_parachain_inherent_data_dispute_statements",
			...
			inherent_data_dispute_statement_sets: prometheus::register(
				prometheus::Counter::new(
					"saitachain_parachain_inherent_data_dispute_statement_sets",
			...
			inherent_data_response_bitfields: prometheus::register(
				prometheus::Histogram::with_opts(
					prometheus::HistogramOpts::new(
						"saitachain_parachain_provisioner_inherent_data_response_bitfields_sent",
			...
			partitioned_disputes: prometheus::register(
				prometheus::CounterVec::new(
					prometheus::Opts::new(
						"saitachain_parachain_provisioner_partitioned_disputes",
			...
			fetched_onchain_disputes: prometheus::register(
				prometheus::Counter::new("saitachain_parachain_fetched_onchain_disputes", "Number of disputes fetched from the runtime"
				)?,
				&registry,
			)?,
		};
