...
use saitama_node_core_pvf_common::prepare::MemoryStats;
use saitama_node_metrics::metrics::{self, prometheus};
		...
		let inner = MetricsInner {
			worker_spawning: prometheus::register(
				prometheus::CounterVec::new(
					prometheus::Opts::new(
						"saitachain_pvf_worker_spawning",
			...
			prepare_enqueued: prometheus::register(
				prometheus::Counter::new(
					"saitachain_pvf_prepare_enqueued",
			...
			prepare_concluded: prometheus::register(
				prometheus::Counter::new(
					"saitachain_pvf_prepare_concluded",
			...
			execute_enqueued: prometheus::register(
				prometheus::Counter::new(
					"saitachain_pvf_execute_enqueued",
			...
			execute_finished: prometheus::register(
				prometheus::Counter::new(
					"saitachain_pvf_execute_finished",
			...
			preparation_time: prometheus::register(
				prometheus::Histogram::with_opts(
					prometheus::HistogramOpts::new(
						"saitachain_pvf_preparation_time",
			...
			preparation_max_rss: prometheus::register(
				prometheus::Histogram::with_opts(
					prometheus::HistogramOpts::new(
						"saitachain_pvf_preparation_max_rss",
			...
			preparation_max_resident: prometheus::register(
				prometheus::Histogram::with_opts(
					prometheus::HistogramOpts::new(
						"saitachain_pvf_preparation_max_resident",
			...
			preparation_max_allocated: prometheus::register(
				prometheus::Histogram::with_opts(
					prometheus::HistogramOpts::new(
						"saitachain_pvf_preparation_max_allocated",
