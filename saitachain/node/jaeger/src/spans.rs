...
//! SaitaChain Jaeger span definitions.
//!
//! ```rust
//! # use saitama_primitives::{CandidateHash, Hash};
//! # fn main() {
...
//! 		// add a `Stage` for [`stc-jaeger`](https://github.com/paritytech/stc-jaeger)
...
use saitama_primitives::{BlakeTwo256, CandidateHash, Hash, HashT, Id as ParaId, ValidatorIndex};
