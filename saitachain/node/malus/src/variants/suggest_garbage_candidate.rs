...
use saitama_node_core_candidate_validation::find_validation_data;
use saitama_node_primitives::{AvailableData, BlockData, PoV};
use saitama_node_subsystem_types::DefaultSubsystemClient;
use saitama_primitives::{CandidateDescriptor, CandidateReceipt};

use saitama_node_subsystem_util::request_validators;
...
// subsystem.
use saitama_node_subsystem::{messages::CandidateBackingMessage, SpawnGlue};
			...
			FromOrchestra::Communication {
				...
				if generate_malicious_candidate {
					...
					let (collator_id, collator_signature) = {
						use saitama_primitives::CollatorPair;
						use sp_core::crypto::Pair;

						let collator_pair = CollatorPair::generate().0;
						let signature_payload = saitama_primitives::collator_signature_payload(
							&relay_parent,
