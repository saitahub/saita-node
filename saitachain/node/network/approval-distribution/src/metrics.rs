...
use saitama_node_metrics::metrics::{prometheus, Metrics as MetricsTrait};
		...
		let metrics = MetricsInner {
			assignments_imported_total: prometheus::register(
				prometheus::Counter::new(
					"saitachain_parachain_assignments_imported_total",
			...
			approvals_imported_total: prometheus::register(
				prometheus::Counter::new(
					"saitachain_parachain_approvals_imported_total",
			...
			unified_with_peer_total: prometheus::register(
				prometheus::Counter::new(
					"saitachain_parachain_unified_with_peer_total",
			...
			aggression_l1_messages_total: prometheus::register(
				prometheus::Counter::new(
					"saitachain_parachain_approval_distribution_aggression_l1_messages_total",
			...
			aggression_l2_messages_total: prometheus::register(
				prometheus::Counter::new(
					"saitachain_parachain_approval_distribution_aggression_l2_messages_total",
			...
			time_unify_with_peer: prometheus::register(
				prometheus::Histogram::with_opts(prometheus::HistogramOpts::new(
					"saitachain_parachain_time_unify_with_peer",
			...
			time_import_pending_now_known: prometheus::register(
				prometheus::Histogram::with_opts(prometheus::HistogramOpts::new(
					"saitachain_parachain_time_import_pending_now_known",
			...
			time_awaiting_approval_voting: prometheus::register(
				prometheus::Histogram::with_opts(prometheus::HistogramOpts::new(
					"saitachain_parachain_time_awaiting_approval_voting",
