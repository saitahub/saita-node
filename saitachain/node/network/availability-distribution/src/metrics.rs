	...
	fn try_register(registry: &Registry) -> Result<Self, PrometheusError> {
		let metrics = MetricsInner {
			fetched_chunks: prometheus::register(
				CounterVec::new(
					Opts::new(
						"saitachain_parachain_fetched_chunks_total",
			...
			served_chunks: prometheus::register(
				CounterVec::new(
					Opts::new(
						"saitachain_parachain_served_chunks_total",
			...
			fetched_povs: prometheus::register(
				CounterVec::new(
					Opts::new(
						"saitachain_parachain_fetched_povs_total",
			...
			served_povs: prometheus::register(
				CounterVec::new(
					Opts::new(
						"saitachain_parachain_served_povs_total",
			...
			retries: prometheus::register(
				Counter::new(
					"saitachain_parachain_fetch_retries_total",
