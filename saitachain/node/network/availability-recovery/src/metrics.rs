...
use saitama_node_subsystem_util::metrics::{
	self,
	...
	fn try_register(registry: &Registry) -> Result<Self, PrometheusError> {
		let metrics = MetricsInner {
			chunk_requests_issued: prometheus::register(
				Counter::new(
					"saitachain_parachain_availability_recovery_chunk_requests_issued",
			...
			chunk_requests_finished: prometheus::register(
				CounterVec::new(
					Opts::new(
						"saitachain_parachain_availability_recovery_chunk_requests_finished",
			...
			time_chunk_request: prometheus::register(
				prometheus::Histogram::with_opts(prometheus::HistogramOpts::new(
					"saitachain_parachain_availability_recovery_time_chunk_request",
			...
			time_erasure_recovery: prometheus::register(
				prometheus::Histogram::with_opts(prometheus::HistogramOpts::new(
					"saitachain_parachain_availability_recovery_time_erasure_recovery",
			...
			time_reencode_chunks: prometheus::register(
				prometheus::Histogram::with_opts(prometheus::HistogramOpts::new(
					"saitachain_parachain_availability_reencode_chunks",
			...
			time_full_recovery: prometheus::register(
				prometheus::Histogram::with_opts(prometheus::HistogramOpts::new(
					"saitachain_parachain_availability_recovery_time_total",
			...
			full_recoveries_finished: prometheus::register(
				CounterVec::new(
					Opts::new(
						"saitachain_parachain_availability_recovery_recoveries_finished",
			...
			full_recoveries_started: prometheus::register(
				Counter::new(
					"saitachain_parachain_availability_recovery_recovieries_started",
