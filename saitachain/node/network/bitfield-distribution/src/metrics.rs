...
use saitama_node_subsystem_util::metrics::{prometheus, Metrics as MetricsTrait};
		...
		let metrics = MetricsInner {
			sent_own_availability_bitfields: prometheus::register(
				prometheus::Counter::new(
					"saitachain_parachain_sent_own_availabilty_bitfields_total",
			...
			received_availability_bitfields: prometheus::register(
				prometheus::Counter::new(
					"saitachain_parachain_received_availabilty_bitfields_total",
			...
			active_leaves_update: prometheus::register(
				prometheus::Histogram::with_opts(prometheus::HistogramOpts::new(
					"saitachain_parachain_bitfield_distribution_active_leaves_update",
			...
			handle_bitfield_distribution: prometheus::register(
				prometheus::Histogram::with_opts(prometheus::HistogramOpts::new(
					"saitachain_parachain_bitfield_distribution_handle_bitfield_distribution",
			...
			handle_network_msg: prometheus::register(
				prometheus::Histogram::with_opts(prometheus::HistogramOpts::new(
					"saitachain_parachain_bitfield_distribution_handle_network_msg",
