...
use saitama_node_network_protocol::{self as net_protocol, OurView};
use saitama_node_subsystem::{messages::NetworkBridgeEvent, ActivatedLeaf};
...
use saitama_primitives::{AuthorityDiscoveryId, CandidateHash, Hash};
...
fn new_test_network(
	...
	let (net_tx, net_rx) = saitama_node_subsystem_test_helpers::single_item_sink();
