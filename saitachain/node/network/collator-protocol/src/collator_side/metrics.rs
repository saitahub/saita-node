		...
		let metrics = MetricsInner {
			advertisements_made: prometheus::register(
				prometheus::Counter::new(
					"saitachain_parachain_collation_advertisements_made_total",
			...
			collations_send_requested: prometheus::register(
				prometheus::Counter::new(
					"saitachain_parachain_collations_sent_requested_total",
			...
			collations_sent: prometheus::register(
				prometheus::Counter::new(
					"saitachain_parachain_collations_sent_total",
			...
			process_msg: prometheus::register(
				prometheus::Histogram::with_opts(
					prometheus::HistogramOpts::new(
						"saitachain_parachain_collator_protocol_collator_process_msg",
			...
			collation_distribution_time: prometheus::register(
				prometheus::HistogramVec::new(
					prometheus::HistogramOpts::new(
						"saitachain_parachain_collator_protocol_collator_distribution_time",
