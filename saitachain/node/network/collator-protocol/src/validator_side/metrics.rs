		...
		let metrics = MetricsInner {
			collation_requests: prometheus::register(
				prometheus::CounterVec::new(
					prometheus::Opts::new(
						"saitachain_parachain_collation_requests_total",
			...
			process_msg: prometheus::register(
				prometheus::Histogram::with_opts(
					prometheus::HistogramOpts::new(
						"saitachain_parachain_collator_protocol_validator_process_msg",
			...
			handle_collation_request_result: prometheus::register(
				prometheus::Histogram::with_opts(
					prometheus::HistogramOpts::new(
						"saitachain_parachain_collator_protocol_validator_handle_collation_request_result",
			...
			collator_peer_count: prometheus::register(
				prometheus::Gauge::new(
					"saitachain_parachain_collator_peer_count",
			...
			collation_request_duration: prometheus::register(
				prometheus::Histogram::with_opts(
					prometheus::HistogramOpts::new(
						"saitachain_parachain_collator_protocol_validator_collation_request_duration",
			...
			request_unblocked_collations: prometheus::register(
				prometheus::Histogram::with_opts(
					prometheus::HistogramOpts::new(
						"saitachain_parachain_collator_protocol_validator_request_unblocked_collations",
