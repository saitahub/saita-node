...
use saitama_node_subsystem_util as util;
use saitama_primitives::{AuthorityDiscoveryId, Hash, SessionIndex, SessionInfo, ValidatorIndex};
	...
	AD: AuthorityDiscovery,
{
	...
	// Checks if the node is an authority and also updates `saitachain_node_is_authority` and
	// `saitachain_node_is_parachain_validator` metrics accordingly.
