...
const LEGACY_VALIDATION_PROTOCOL_V1: &str = "/saitachain/validation/1";
const LEGACY_COLLATION_PROTOCOL_V1: &str = "/saitachain/collation/1";
...
mod tests {
	...
	fn all_protocol_names_are_known() {
		...
		let validation_legacy = "/saitachain/validation/1";
		assert_eq!(
		...
		let collation_legacy = "/saitachain/collation/1";
		assert_eq!(
