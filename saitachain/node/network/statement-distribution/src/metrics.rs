		...
		let metrics = MetricsInner {
			statements_distributed: prometheus::register(
				prometheus::Counter::new(
					"saitachain_parachain_statements_distributed_total",
			...
			sent_requests: prometheus::register(
				prometheus::Counter::new(
					"saitachain_parachain_statement_distribution_sent_requests_total",
			...
			received_responses: prometheus::register(
				prometheus::CounterVec::new(
					prometheus::Opts::new(
						"saitachain_parachain_statement_distribution_received_responses_total",
			...
			active_leaves_update: prometheus::register(
				prometheus::Histogram::with_opts(
					prometheus::HistogramOpts::new(
						"saitachain_parachain_statement_distribution_active_leaves_update",
			...
			share: prometheus::register(
				prometheus::Histogram::with_opts(
					prometheus::HistogramOpts::new(
						"saitachain_parachain_statement_distribution_share",
			...
			network_bridge_update: prometheus::register(
				prometheus::HistogramVec::new(
					prometheus::HistogramOpts::new(
						"saitachain_parachain_statement_distribution_network_bridge_update",
			...
			statements_unexpected: prometheus::register(
				prometheus::CounterVec::new(
					prometheus::Opts::new(
						"saitachain_parachain_statement_distribution_statements_unexpected",
			...
			created_message_size: prometheus::register(
				prometheus::Gauge::with_opts(prometheus::Opts::new(
					"saitachain_parachain_statement_distribution_created_message_size",
