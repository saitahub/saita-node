...
//!
//! The grid uses the gossip topology defined in [`saitama_node_network_protocol::grid_topology`].
...
mod tests {
	...
	use saitama_node_network_protocol::grid_topology::TopologyPeerInfo;
