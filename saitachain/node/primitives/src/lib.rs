...
//!
//! Unlike the `saitama-primitives` crate, these primitives are only used on the node-side,
...
#[cfg(not(target_os = "unknown"))]
pub struct Collation<BlockNumber = saitama_primitives::BlockNumber> {
