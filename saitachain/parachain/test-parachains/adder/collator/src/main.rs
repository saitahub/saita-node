...
use saitama_cli::{Error, Result};
use saitama_node_primitives::CollationGenerationConfig;
use saitama_node_subsystem::messages::{CollationGenerationMessage, CollatorProtocolMessage};
use saitama_primitives::Id as ParaId;
	...
	match cli.subcommand {
		...
		None => {
			...
			runner.run_node_until_exit(|config| async move {
				...
				let full_node = saitama_service::build_full(
					config,
					saitama_service::NewFullParams {
						is_parachain_node: saitama_service::IsParachainNode::Collator(
