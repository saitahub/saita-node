...
mod tests {
	...
	fn v6_deserialized_from_actual_data() {
		...
		// Steps:
		// 1. Go to SaitaChain.js -> Developer -> Chain state -> Storage
		// 2. Set these parameters:
		//   2.1. selected state query: configuration; activeConfig():
		// SaitaChainRuntimeParachainsConfigurationHostConfiguration   2.2. blockhash to query at:
		...
		// 3. Go to SaitaChain.js -> Developer -> Chain state -> Raw storage
