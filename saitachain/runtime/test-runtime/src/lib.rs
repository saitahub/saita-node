...
use saitama_runtime_parachains::reward_points::RewardValidatorsWithEraPoints;
use primitives::{
...
pub const VERSION: RuntimeVersion = RuntimeVersion {
	spec_name: create_runtime_str!("saitachain-test-runtime"),
	impl_name: create_runtime_str!("parity-saitachain-test-runtime"),
	authoring_version: 2,
	spec_version: 1056,
	impl_version: 0,
...
parameter_types! {
	pub Prefix: &'static [u8] = b"Pay STC to the account:";
}
