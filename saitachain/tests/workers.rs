...
use saitama_cli::NODE_VERSION;
use std::process::Command;

const PREPARE_WORKER_EXE: &str = env!("CARGO_BIN_EXE_SaitaChain-prepare-worker");
const EXECUTE_WORKER_EXE: &str = env!("CARGO_BIN_EXE_SaitaChain-execute-worker");
