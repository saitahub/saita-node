...
parameter_types! {
	pub const StcLocation: MultiLocation = MultiLocation::parent();
...
parameter_types! {
	...
	pub StcPerSecondPerByte: (AssetId, u128, u128) = (Concrete(Parent.into()), 1, 1);
...
pub type LocalAssetTransactor = (
	XcmCurrencyAdapter<Balances, IsConcrete<StcLocation>, LocationToAccountId, AccountId, ()>,
	NonFungiblesAdapter<
		ForeignUniques,
...
impl Config for XcmConfig {
	...
	type Trader = FixedRateOfFungible<StcPerSecondPerByte, ()>;
